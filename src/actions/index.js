...
export function fetchReviews(id) {
    ...
    const request = axios.get('https://raw.githubusercontent.com/ravijoh1/json/master/reviews.json');
...
export function fetchLocations(input) {
    ...
    const request = axios.get('https://raw.githubusercontent.com/ravijoh1/json/master/locations.json');
